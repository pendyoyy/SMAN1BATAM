...
public class ActivityNilaiTugas2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_tugas2);
        ...
        modelCall.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                if (respon.getSuccess() == 1)
                    Toast.makeText(ActivityNilaiTugas2.this, respon.getMassage(), Toast.LENGTH_SHORT).show();

                listNilai = response.body().nilaiTugas;
                adJadwalUji = new AdapterNilai(ActivityNilaiTugas2.this, listNilai);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(ActivityNilaiTugas2.this, "Erorr :" + t.getMessage(), Toast.LENGTH_SHORT).show();
